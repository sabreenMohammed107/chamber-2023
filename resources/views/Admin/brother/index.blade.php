    ...
    <div class="col-md-12">
        ...
        <div class="ms-panel">
            <div class="ms-panel-header d-flex justify-content-between">
                ...
                <a href="{{route('brother.create') }}" class="btn btn-dark"> إضافة اتفاقية تآخى</a>
            </div>
                    ...
                    <table id="courseEval" class="dattable table table-striped thead-dark  w-100">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('brother.edit',$row->id) }}" class="btn btn-info d-inline-block">تعديل</a>
                                    <a href="#" onclick="destroy('this brother','{{$row->id}}')" class="btn d-inline-block btn-danger">مسح</a>
