...
class CommercialAgreementController extends Controller
{
    protected $object;
    ...
    public function __construct(Commerical_agreement $object)
    {
        $this->middleware('auth:admin');

        $this->object = $object;
        $this->viewName = 'Admin.commercialAgreement.';
        $this->routeName = 'commercialAgreement.';
    ...
    {
        $rows = Commerical_agreement::orderBy("created_at", "Desc")->get();
    ...
    {
        $row = Commerical_agreement::where('id', '=', $id)->first();
